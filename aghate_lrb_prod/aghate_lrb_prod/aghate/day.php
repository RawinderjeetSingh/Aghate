...
if($ServiceInfose[0]['enable_periodes']=='y')
$TableLoc='agt_ipop';
else
$TableLoc='agt_loc';
...
if (authGetUserLevel($_SESSION['login'],$room_id) >= 2)
{
	$UrlEdit=$ModuleReservationView."?area=".$area."&amp;year=$year&amp;month=$month&amp;day=$day&amp;page=day&table_loc=".$TableLoc;
...
echo "<table id='TablePanier' cellspacing='0' cellpadding='0' border='1'>";
