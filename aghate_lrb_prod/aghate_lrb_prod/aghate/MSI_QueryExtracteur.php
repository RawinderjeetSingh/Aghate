...
if ( ($_submit=="EXECUTER" )and (strlen($_SQL) > 5)){
	...
	{
		case  "SIMPA" :
			$Conn=ConnectOracle($ConnexionStringSIMPA," "," ");
			break;
		case "GILDA" :
			$Conn=ConnectOracle($ConnexionStringGILDA," "," ");
			break;
		case  "SAG" :
			$Conn=ConnectOracle($ConnexionStringSAG," "," ");			
			break;
		case  "SUSIE" :
			$Conn=ConnectOracle($ConnexionStringSUSIE," "," ");						
			break;
		default :
