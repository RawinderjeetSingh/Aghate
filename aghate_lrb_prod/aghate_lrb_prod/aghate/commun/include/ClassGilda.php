...
class Gilda
{
	...
	*/
	...
	function GetSejourInfoParNda($nda)
	{
		$sql="SELECT NOUF,NODA,to_char(DAMVAD,'DD/MM/YYYY') as DAMVAD,  SUBSTR(HHMVAD,1,2)||':'||SUBSTR(HHMVAD,3,2) as HHMVAD,TYMVAD
		 FROM MVT WHERE NODA='".$nda."' AND TYMAJ !='D' ORDER BY DAMVAD,HHMVAD";
		$res = $this->OraSelect($sql);
		return $res;		
	}
